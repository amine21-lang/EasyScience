...
public class Editeur_infos_page {
    ...
    @FXML
    private Button infos_modify_infos;
    ...
    @FXML
    void click_to_modify_editor_infos(MouseEvent event) {
        if (!isEditable) {
            ...
            isEditable = true;
            infos_modify_infos.setText("Enregistrer");
        } else {
            // Enregistrer les modifications dans la base de données
            saveModifications();
            isEditable = false;
            infos_modify_infos.setText("Modifier");
        }
    }
